...
def draw_entity(con, entity, fov_map):
    if libtcod.map_is_in_fov(fov_map, entity.position_x, entity.position_y):
        libtcod.console_set_default_foreground(con, entity.color)
        libtcod.console_put_char(con, entity.position_x, entity.position_y,
...
def clear_entity(con, entity):
    ...
    """
    libtcod.console_put_char(con, entity.position_x,
                             entity.position_y, ' ', libtcod.BKGND_NONE)
...
def get_names_under_mouse(mouse, entities, fov_map):
    ...
    names = [entity.name for entity in entities
             if entity.position_x == x and entity.position_y == y and libtcod.map_is_in_fov(fov_map, entity.position_x, entity.position_y)]
    names = ', '.join(names)
